     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{'https://avatars.githubusercontent.com/Ravishetty07'}"
                     alt="Ravi Shetty"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/Ravishetty07';">
                <h2 class="profile-name"><center>Ravi - Pavan</center></h2>
                <p class="profile-title"><b>Final Year Project - SDM</b></p>
                <div class="social-links">
                    <a href="https://github.com/Ravishetty07" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/ravi-m-shetty/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:ravishetty05082@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    <center>
                    Resume AI is a final year BCA project developed by Ravi M and Pavan H from SDM Degree College, Honnavar, 
                    It uses AI and NLP to analyze resumes,provide improvement suggestions, 
                    and help users create ATS-friendly resumes with smart templates.
                </center>
                </p>
            </div>
        """, unsafe_allow_html=True)
